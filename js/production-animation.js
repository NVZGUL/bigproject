$(document).ready(function(){
   ...
   // console.log(start_const);
    ...
    //var my_text = $("#lsv-dairy-products__next-animation>label").text();
    //console.log("my text: " + my_text)
    //var my_start_text = "Посмотреть  производство";
    //if(my_text == my_start_text){
